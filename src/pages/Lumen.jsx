    ...
    <div ref={rootRef} style={{ position: 'relative', width: '100%', overflow: 'hidden' }}>
      ...
      >
        ...
        <div data-navlinks style={{ display: 'flex', alignItems: 'center', gap: 34, fontSize: 15, fontWeight: 600, color: '#3a2f52' }}>
          <a href="#story" style={{ textDecoration: 'none' }}>Philosophy</a>
          <a href="#strategies" style={{ textDecoration: 'none' }}>Strategies</a>
          <a href="#performance" style={{ textDecoration: 'none' }}>Performance</a>
          <a href="#journey" style={{ textDecoration: 'none' }}>Journey</a>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
