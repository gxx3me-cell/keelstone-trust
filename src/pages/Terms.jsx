...
const SECTIONS = [
  {
    ...
    body: `By accessing or using the Keelstone Trust platform ("Platform"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to all of these Terms, you may not access or use the Platform. These Terms constitute a legally binding agreement between you ("User", "Client", "you") and Keelstone Trust ("Company", "we", "us", "our").`,
  },
  {
    title: '2. Description of Services',
    body: `Keelstone Trust provides professionally managed digital asset portfolio services. Our investment team allocates and manages client capital across our defined strategies — Growth, Balanced, Conservative, and Private Mandate — on the client's behalf. We do not provide personalised financial advice, and nothing on this Platform should be construed as such.`,
  },
  {
    title: '3. Eligibility',
    body: `You must be at least 18 years of age to use the Platform. By accessing the Platform, you represent and warrant that you meet this requirement. You further represent that you are not subject to any sanctions or restrictions that would prohibit you from using our services. Keelstone Trust reserves the right to refuse service to anyone at any time.`,
  },
  {
    ...
    <div style={{ minHeight: '100vh', background: '#fff', color: C.ink }}>
      ...
      <div style={{ background: C.surface, borderBottom: `1px solid ${C.line}`, padding: 'clamp(40px,6vh,72px) clamp(18px,5vw,72px)' }}>
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 15, color: C.muted, margin: 0 }}>Last updated: 1 July 2026 · Please read these terms carefully before using the Keelstone Trust Platform.</p>
        </div>
      </div>
